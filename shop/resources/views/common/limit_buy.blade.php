...
<link href="home/css/purebox-metro.css" rel="stylesheet"  type="text/css"/>
...
<!--顶部样式-->
 <div id="header_top">
  ...
  <div class="logo"><a href="{{ url('index') }}"><img src="images/logo.png" /></a></div>
  <!--结束图层-->
  <div class="Search">
...
<div id="slideBox" class="slideBox">
			...
			<div class="bd">
				<ul>
					<li><a href="#" target="_blank"><div style="background:url(home/AD/ad-9.jpg) no-repeat rgb(255, 227, 130); background-position:center; width:100%; height:350px;"></div></a></li>
					<li><a href="#" target="_blank"><div style="background:url(home/AD/ad-9.jpg) no-repeat rgb(255, 227, 130); background-position:center ; width:100%; height:350px;"></div></a></li>
					<li><a href="#" target="_blank"><div style="background:url(home/AD/ad-9.jpg) no-repeat rgb(226, 155, 197); background-position:center; width:100%; height:350px;"></div></a></li>
				</ul>
			</div>
