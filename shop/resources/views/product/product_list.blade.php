 ...
 <div id="header_top">
  <div id="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
	   <li class="hd_menu_tit zhuce" data-addclass="hd_menu_hover">欢迎光临本店！<a href="{{ url('login') }}" class="red">[请登录]</a> 新用户<a href="{{ url('register') }}" class="red">[免费注册]</a></li>
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="{{ url('userOrder') }}">我的订单</a></li> 
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"> <a href="{{ url('cart') }}">购物车</a> </li>
  ...
  <div class="logo"><a href="{{ url('index') }}"><img src="home/images/logo.png" /></a></div>
  <!--结束图层-->
  <div class="Search">
 ...
 <div class="hd_Shopping_list" id="Shopping_list">
   ...
   <div class="dorpdown-layer">
    <div class="spacer"></div>
	 ...
	 <ul class="p_s_list">	   
		<li>
		    <div class="img"><img src="home/products/p_7.jpg"></div>
...
<div class="index_style clearfix">
  <div id="allSortOuterbox" class="display">
	...
	<div class="Navigation" id="Navigation">
		 <ul class="Navigation_name">
			<li><a href="{{ url('index') }}">首页</a></li>
				<li><a href="{{ url('productList') }}">产品列表</a></li>
			<li><a href="{{ url('limitBuy') }}">限时特卖</a><em class="hot_icon"></em></li>
			<li><a href="#">联系我们</a></li>
			<li><a href="#">鲜盟人才</a></li>
			<li><a href="#">鲜盟金融</a></li>
			<li><a href="#">鲜盟投资</a></li>
	...
	<script>$("#Navigation").slide({titCell:".Navigation_name li"});</script>
     <!-- <a href="#" class="link_bg"><img src="home/images/link_bg_03.png" /></a>-->		
  </div>
</div>
</div>
<!--产品列表样式-->
   ...
   <div id="Filter_style">
    ...
    <div class="page_recommend">
      ...
      <div class="bd">
       <ul>
        <li>
         <div class="img"><a href="#"><img src="home/products/p_4.jpg" width="120" height="120" /></a></div>
         <div class="pro_info">
        ...
        <li>
         <div class="img"><a href="#"><img src="home/products/p_55.jpg" width="120" height="120" /></a></div>
         <div class="pro_info">
          <a href="#">洗颜专科 柔澈泡沫 洁面乳 120g（资生堂旗下）</a>
          <p class="Price"><i>￥</i>231.00</p>
          <p class="Sales">热销：<b>1234</b>件</p>
        ...
        <li>
         <div class="img"><a href="#"><img src="home/products/p_17.jpg" width="120" height="120" /></a></div>
         <div class="pro_info">
          <a href="#">洗颜专科 柔澈泡沫 洁面乳 120g（资生堂旗下）</a>
          <p class="Price"><i>￥</i>231.00</p>
          <p class="Sales">热销：<b>1234</b>件</p>
        ...
        <li>
         <div class="img"><a href="#"><img src="home/products/p_54.jpg" width="120" height="120" /></a></div>
         <div class="pro_info">
          <a href="#">洗颜专科 柔澈泡沫 洁面乳 120g（资生堂旗下）</a>
          <p class="Price"><i>￥</i>231.00</p>
          <p class="Sales">热销：<b>1234</b>件</p>
        ...
        <li>
         <div class="img"><a href="#"><img src="home/products/p_58.jpg" width="120" height="120" /></a></div>
         <div class="pro_info">
          <a href="#">洗颜专科 柔澈泡沫 洁面乳 120g（资生堂旗下）</a>
          <p class="Price"><i>￥</i>231.00</p>
          <p class="Sales">热销：<b>1234</b>件</p>
  ...
  <!--浏览记录-->
   ...
   <div class="Record">
	 ...
	 <ul>
	  <li>
	   <a href="#">
	   <p><img src="home/products/p_32.jpg"></p>
	  ...
	  <li>
	   <a href="#">
	   <p><img src="home/products/p_33.jpg"></p>
	  ...
	  <li>
	   <a href="#">
	   <p><img src="home/products/p_34.jpg"></p>
	   <p class="p_name">商品名称</p>
	   </a>
	   <p><span class="p_Price left">价格:<b>￥5.30</b></span><span class="p_Sales right">销量：2345件</span></p>
	  </li>
       <li>
	   <a href="#">
	   <p><img src="home/products/p_36.jpg"></p>
	   <p class="p_name">商品名称</p>
	   </a>
	   <p><span class="p_Price left">价格:<b>￥5.30</b></span><span class="p_Sales right">销量：2345件</span></p>
	  </li>
   ...
   <!--销售排行-->
    ...
    <div class="ranking_list">
     <ul id="tabRank">
      ...
      <dd class="clearfix">
      <a href="#"><img src="home/products/p_29.jpg" width="90" height="90" /></a>
...
$(function() { 
 ...
 <div class="p_list  clearfix">
   <ul>
	...
	<div class="Borders">
	 <div class="img"><a href="Product_Detailed.html"><img src="home/products/P_1.jpg" style="width:220px;height:220px"></a></div>
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_Detailed.html"><img src="home/products/P_2.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="Product_Detailed.html">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
    ...
    <em class="icon_special tejia"></em>
	<div class="Borders">
	 <div class="img"><a href="Product_Detailed.html"><img src="home/products/P_3.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="Product_Detailed.html">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="Product_Detailed.html"><img src="home/products/P_4.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="Product_Detailed.html">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<div class="Borders">
	 <div class="img"><a href="Product_Detailed.html"><img src="home/products/P_5.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="Product_Detailed.html">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_6.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_7.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_15.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_9.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_8.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_11.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_16.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
	...
	<li class="gl-item">
	<div class="Borders">
	 <div class="img"><a href="#"><img src="home/products/P_17.jpg" style="width:220px;height:220px"></a></div>
	 <div class="Price"><b>¥89</b><span>[¥49.01/500g]</span></div>
	 <div class="name"><a href="#">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a></div>
	 <div class="Review">已有<a href="#">2345</a>评论</div>
	 <div class="p-operate">
